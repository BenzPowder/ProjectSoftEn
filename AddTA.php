...
<head>
    ...
    <title>เพิ่มผู้ช่วยสอนอาจารย์</title>
...
function fncSubmit()
{
    ...
    {
        alert('กรุณากรอกรหัสรหัสผู้ช่วยสอน Ex.593020466-7');
        return false;
    }

    if(document.getElementById('TAName').value == "")
    {
        alert('กรุณากรอกชื่อผู้ช่วยสอน Ex.นายทดสอบ ทดสอบ');
        return false;
    }
}
</script>
    ...
    <div class="container">
        <form  action="functionAddTA.php" method="post" onSubmit="JavaScript:return fncSubmit();">
            ...
            <div class="form-group">
                ...
                <input type="text" name="TAName" class="form-control" id="TAName" required pattern="[a-zA-Zก-ุฯ-๙\s]*" title="กรุณากรอกตัวอักษร" placeholder="นายทดสอบ ทดสอบ" >
            </div>
            <div align="center">
