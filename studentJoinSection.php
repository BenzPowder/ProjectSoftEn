...
<div class="container">
  ...
  <div class="form-group">
    <div align="center">
        <label>แสดง ชื่อวิชา</label>
    </div>
  </div>
  
  <br> <br>
  <div align="left">
    Section 1      <button type="submit" class="btn btn-primary" id="addSubject">เข้าร่วม</button> <br> <br> <br>
    Section 2      <button type="submit" class="btn btn-primary" id="addSubject">เข้าร่วม</button>
  </div>
  <br>
</form>
</div>
