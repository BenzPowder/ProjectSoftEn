...
<div class="container">
  <form action="add.php" method="post">
  <div align="center">
    <button type="button" class="btn btn-primary" id="teacher">teacher</button>
    <button type="button" class="btn btn-primary" id="ta">ta</button>
    <button type="button" class="btn btn-primary" id="student">student</button>
  </div>
  <br>
</form>
</div>
