...
?>
                ...
                <div class="container" align="center">
                    <a href="addSubject.php"><input type="button" name="addSubject" class="btn btn-primary" value="เพิ่มวิชา"></a>
                    <a href="taAddTeacher.php"><input type="button" name="addTeacher" class="btn btn-primary" value="เพิ่มอาจารย์"> </a>
                </div>
