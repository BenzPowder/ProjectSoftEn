...
<html lang="en">
  <head>
    ...
    <title>เพิ่มผู้ช่วยอาจารย์</title>
...
<div class="container">
  ...
  <div class="form-group">
    <div align="center">
        <label>เพิ่มผู้ช่วยอาจารย์</label>
    </div>
    
  </div>
  <div class="form-group">
      <label>รหัสผู้ช่วยอาจารย์</label>
      <select class="form-control" name="taID" id="cSection">
      <option value="1"></option>
      <option value="2">593020111-2</option>
      <option value="3">593020222-3</option>
      <option value="4">593020333-4</option>
      <option value="5">593020444-5</option>
      </select>
    </div>
    <label>วิชา</label>
    <input type="text" class="form-control" id="subject" placeholder=""> <br>
    <label>ปี</label>
    <input type="text" class="form-control" id="year" placeholder=""> <br>
    <label>เทอม</label>
    <input type="text" class="form-control" id="year" placeholder="">
  <div align="right"> <br>
    <button type="submit" class="btn btn-primary" id="addSubject">เพิ่มผู้ช่วยอาจารย์</button>
  </div>
  <br>
</form>
</div>
